...
<script type="text/javascript">
  ...
  flashvars.xmlSource = "spectacle.xml";
...
<div id="templatemo_main">
    <center>
   <div class="fp_box5b">
         <a href="representations.html"><img src="images/invoice.png" alt="Voir les représentations" />
        <h2><a href="representations.html"> Voir représentations</h2></a>
        <p><center>Liste des dates, heures et sales de représentation</p> </center>
    </div>
    </center>
