...
<div id="templatemo_main">
    ...
    <div class="col_12 float_l">
    	<h4>Adresse</h4>
        <h6><strong>Billets Online</strong></h6>
          		1100 Rue Notre-Dame Ouest<br />
                Montreal, QC H3C 1K3<br />
                (514) 396-8800<br /><br />
				
		<strong>Tel:</strong> 514-999-1234 <br />
        <strong>Courriel:</strong> <a href="mailto:info@company.com">info@company.com</a>  <br />
        
        <div class="cleaner h40"></div>  
        <h4>Notre emplacement</h4>
	  	<iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.ca/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=%C3%89cole+de+technologies+sup%C3%A9rieure&amp;aq=&amp;sll=45.558042,-73.730303&amp;sspn=0.763475,1.783905&amp;ie=UTF8&amp;hq=%C3%89cole+de+technologies+sup%C3%A9rieure&amp;hnear=&amp;t=m&amp;cid=13200797186349876726&amp;z=14&amp;iwloc=A&amp;output=embed"></iframe><br /><small><a href="https://maps.google.ca/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=%C3%89cole+de+technologies+sup%C3%A9rieure&amp;aq=&amp;sll=45.558042,-73.730303&amp;sspn=0.763475,1.783905&amp;ie=UTF8&amp;hq=%C3%89cole+de+technologies+sup%C3%A9rieure&amp;hnear=&amp;t=m&amp;cid=13200797186349876726&amp;z=14&amp;iwloc=A" style="color:#0000FF;text-align:left">Grossir la carte</a></small>
        
	</div>
    <div class="col_12 float_r">
    	<h4>Envoyez nous un message</h4>
        <p>Bla bla bla bla Valider <a href="http://validator.w3.org/check?uri=referer" rel="nofollow"><strong>XHTML</strong></a> &amp; <a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow"><strong>CSS</strong></a>.</p>
        <div id="contact_form">
           <form method="post" name="contact" action="#">
                        
                        <label for="author">Nom:</label> <input type="text" id="author" name="author" class="required input_field" />
                        <div class="cleaner h10"></div>
                        <label for="email">Courriel:</label> <input type="text" id="email" name="email" class="validate-email required input_field" />
                        <div class="cleaner h10"></div>
                        
						<label for="subject">Sujet:</label> <input type="text" name="subject" id="subject" class="input_field" />
						...
						<input type="reset" value="Éffacer" id="reset" name="reset" class="submit_btn float_r" />
            </form>
        </div>
	</div>
